...
ALLOWED_TEAMS = [
    ...
    "Inter Milan", "Napoli", "AS Roma", "Como 1907",
    "Paris Saint-Germain", "RC Lens", "LOSC Lille", "Olympique Lyonnais",
    "PSV Eindhoven", "Feyenoord", "NEC Nimègue", "FC Twente",
    "FC Porto", "Sporting CP", "SL Benfica", "SC Braga",
    "Coventry City", "Ipswich Town", "Millwall", "Southampton",
...
ALLOWED_COMPETITIONS = [
    ...
    "Campeonato Brasileiro Série A", "Ligue des champions UEFA"
]
...
def list_predictions(
    ...
    query = query.filter(
        or_(
            ...
            Match.away_team.has(Team.name.in_(ALLOWED_TEAMS)),
            Match.competition.has(Competition.name.in_(ALLOWED_COMPETITIONS))
        )
    )
