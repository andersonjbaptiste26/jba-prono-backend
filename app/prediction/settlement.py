# ============================================================================
# DÉPRÉCIÉ depuis v0.3.0 — Le règlement des paris se fait désormais
# côté client (fonction evaluateSelection() dans index.html).
# Conservé en commentaire pour référence future.
# ============================================================================
#
# """
# Détermine si chaque sélection d'un pari est gagnée ou perdue.
# """
# import re
...
#             settled += 1
#     db.commit()
#     return {"bets_settled": settled, "bets_checked": len(bets)}
